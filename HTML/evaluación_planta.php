...
<body>
    ...
    <section id="evaluacion">
        ...
        <form id="evaluationForm">
            ...
            <div class="question">
                <p>10. ¿Cuál de estos NO es una responsabilidad del empleado?</p>
            ...
            <div class="question">
                <p>11.Cuando a un empleado le dan incapacidad por enfermedad común ¿quién cubre los gastos los dos primeros días?</p>
                <label><input type="radio" name="q11" value="a" required> La empresa </label>
                <label><input type="radio" name="q11" value="b"> La EPS</label>
                <label><input type="radio" name="q11" value="c"> La ARL</label>
                <label><input type="radio" name="q11" value="d"> El empleado</label>
            </div>

            <div class="question">
                <p>12. El empleador debe suministrar los recrusos para el desarrollo de las actividades del SG - SST</p>
                <label><input type="radio" name="q12" value="a" required> Verdadero </label>
                <label><input type="radio" name="q12" value="b"> Falso</label>
            </div>

            <div class="question">
                <p>13.¿Qué es una incapacidad por enfermedad de origen común o general</p>
                <label><input type="radio" name="q13" value="a" required> Es una enfermedad adquirida en el lugar de trabajo. </label>
                <label><input type="radio" name="q13" value="b"> Es un estado de inhabilidad física o mental que impide a una persona trabajar, causado por una enfermedad general o accidente común</label>
                <label><input type="radio" name="q13" value="c"> Es una condición temporal causada por accidentes laborales.</label>
                <label><input type="radio" name="q13" value="d"> Es una incapacidad permanente causada por enfermedades crónicas </label>
            </div>
    ...
    <script src="../js//evaluación_planta.js"></script>
